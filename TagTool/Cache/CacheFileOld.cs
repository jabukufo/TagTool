...
{
    public abstract class CacheFileOld
    {
        ...
        public class StringTable : List<string>
        {
            ...
            public StringTable(CacheFileOld Cache)
            {
                cache = Cache;
        ...
        public class LocaleTable : List<string>
        {
            ...
            public LocaleTable(CacheFileOld Cache, GameLanguage Lang)
            {
                cache = Cache;
        ...
        public T Deserialize<T>(string path, string group, CacheFileOld cache)
        {
