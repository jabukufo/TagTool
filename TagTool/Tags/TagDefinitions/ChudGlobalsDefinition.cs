...
namespace TagTool.Tags.TagDefinitions
{
    ...
    public class ChudGlobalsDefinition
    {
        ...
        public class HudGlobal
        {
            ...
            [TagStructure(Size = 0x14, MaxVersion = GameDefinitionSet.HaloOnline449175)]
            [TagStructure(Size = 0x18, MinVersion = GameDefinitionSet.HaloOnline498295)]
            public class HudSound
            {
                public uint LatchedTo;
                [MinVersion(GameDefinitionSet.HaloOnline498295)] public uint LatchedTo2;
                public float Scale;
                public List<UnknownBlock> Unknown;
