...
{
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD4, MaxVersion = GameDefinitionSet.HaloOnline235640)]
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD8, MinVersion = GameDefinitionSet.HaloOnline301003, MaxVersion = GameDefinitionSet.HaloOnline449175)]
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD4, MinVersion = GameDefinitionSet.HaloOnline498295)]
    public class Sound
    {
        public uint Flags;
        public uint Unknown;
