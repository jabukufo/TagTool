...
{
    [TagStructure(Name = "globals", Class = "matg", Size = 0x608, MaxVersion = GameDefinitionSet.HaloOnline449175)]
    [TagStructure(Name = "globals", Class = "matg", Size = 0x618, MinVersion = GameDefinitionSet.HaloOnline498295, MaxVersion = GameDefinitionSet.HaloOnline571627)]
    [TagStructure(Name = "globals", Class = "matg", Size = 0x614, MinVersion = GameDefinitionSet.HaloOnline700123)]
    public class Globals
    {
        ...
        [MinVersion(GameDefinitionSet.HaloOnline498295)] public TagInstance ArmorGlobals;
        ...
        [TagStructure(Size = 0x70, MaxVersion = GameDefinitionSet.HaloOnline449175)]
        [TagStructure(Size = 0x78, MinVersion = GameDefinitionSet.HaloOnline498295)]
        public class PlayerControlBlock
        {
            ...
            [MaxVersion(GameDefinitionSet.HaloOnline449175)] public float CrosshairLocationX;
            [MaxVersion(GameDefinitionSet.HaloOnline449175)] public float CrosshairLocationY;
            [MinVersion(GameDefinitionSet.HaloOnline498295)] public List<CrosshairLocation> CrosshairLocations;
            ...
            public uint Unknown;
            public uint Unknown2;
            [MinVersion(GameDefinitionSet.HaloOnline498295)] public uint Unknown3;
