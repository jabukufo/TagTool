                ...
                get
                {
                    ...
                    switch (Cache.Version)
                    {
                        ...
                        case DefinitionSet.Halo1PC:
                            xml = new MemoryStream(Encoding.ASCII.GetBytes(TagTool.Properties.Resources.Classes_H1));
                            break;

                        case DefinitionSet.Halo2Xbox:
                            xml = new MemoryStream(Encoding.ASCII.GetBytes(TagTool.Properties.Resources.Classes_H2));
                            break;
